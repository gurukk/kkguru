...
public class JQuery_Or_Web_Dropdown {
    private static final Logger logger = LogManager.getLogger(JQuery_Or_Web_Dropdown.class);
    ...
    public static boolean Verify_Count_Of_Options_In_Dropdown(Page page, HashMap<String, String> map, String reportLogFileName) throws IOException {
        ...
        int expectedOptionsAvailableCountInDropdown = Integer.parseInt(map.get("ATTRIBUTE_VALUE"));
        try {
